...
import dotenv
from langchain.storage import LocalFileStore # 文件存储库
...
if __name__ == '__main__':
    ...
    embeddings_with_cache = CacheBackedEmbeddings.from_bytes_store(
      embeddings,LocalFileStore("./cache"), namespace= embeddings.model, query_embedding_cache=True
    )

    # 2. 嵌入文本
    query_vector = embeddings_with_cache.embed_query("我叫xin，我喜欢打篮球")
